...
<form id="frm" name="frm" method="post" action="#">
	...
	<a href="./hospInfoBoard_write" class="">글쓰기</a> <br />
	...
	<c:if test="${page==1 || page == null}">
		...
		<button type="button" 
			onclick="javascript:location.href='./hospInfoBoard?page=1">이전
		</button>
	</c:if>
	<c:if test="${page>1 }">
		<button type="button" 
	...
	<c:if test="${page == lastPage }">
		<button type="button"
			onclick="javascript:location.href='./hospInfoBoard?page=${lastPage}'">다음
			<i class="fa fa-angle-right" aria-hidden="true"></i>
		</button>
	</c:if>
	<c:if test="${page != lastPage }">
		<button type="button"
			onclick="javascript:location.href='./hospInfoBoard?page=${page+1}'">다음
			<i class="fa fa-angle-right" aria-hidden="true"></i>
		</button>
	</c:if>
		<button type="button"
			onclick="javascript:location.href='./hospInfoBoard?page=${lastPage}'">끝
