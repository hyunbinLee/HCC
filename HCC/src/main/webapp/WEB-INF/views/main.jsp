		...
		<%@ include file="common/inc_top.jsp"%>
					...
					<form name="f" action="${loginUrl}" method="post">
						...
						<div class="login_area m_b30">
							...
							<div class="login_box m_b5">
								<div></div><input type="text" name="id" id="id" class="" value="" 	placeholder="아이디">
								<div></div><input type="password" name="pw" id="pw" class="" value=""	placeholder="비밀번호">
							</div>
			...
			<div class="right_area">
				...
				<div class="notice_board_wrap m_b50">
					<div class="notice_board_title p_b5">
						<span class="p_b5">병에 대한 후기</span> <a href="#" class="right"><span>+
								더보기</span></a>
					</div>
				...
				<div class="notice_board_wrap">
					<div class="notice_board_title p_b5">
						<span class="p_b5">게시판</span> <a href="#" class="right"><span>+ 더보기</span></a>
					</div>
					<div class="notice_board_tap">
						<ul>
							<li>의사</li>
